...
export function startMainReactRoot() {
  // /-/admin/*
  // /home/kajmagnus/dev/ed/ed3/app/views/adminPage.scala.html
  // <div id="esPageColumn">
  ...
  // /home/kajmagnus/dev/ed/ed3/app/views/specialpages/createSomethingHerePage.scala.html
  // <div class="container">
  ...
  // /-/create-test-site
  // /home/kajmagnus/dev/ed/ed3/app/views/createsite/createSitePage.scala.html
  ...
  renderOrHydrate(
      Router({}, Switch({},
        ...
        Route({ path: '/', component: PageWithState }),
