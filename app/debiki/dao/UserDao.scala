...
trait UserDao {
  ...
  def blockGuestImpl(browserIdData: BrowserIdData, guestId: UserId, numDays: Int,
      ...
      val ipBlock = Block(
        ...
        browserIdCookie = browserIdData.idCookie,
      ...
      browserIdCookieBlock foreach transaction.insertBlock // (6PKU02Q)
