...
Talkyard has: -->
 ...
 - Discuss ideas and news, Reddit and Hacker news style.
 - Solve problems, step by step: flat chronological comments (coming soon).
 - Embedded comments, like Disqus, for your blog, or API docs?
...
Within half a year? a year? (today is August 2018),
the plan is that there'll be a white labelled mobile app. Meaning, people will be able to install your community, on their mobile phones, as a separate app with your icon. No need to submit for review to Google Play Store or Apple App Store. Push notifications for Android, however, initially, not for iOS (Apple and iOS currently cannot do WPA mobile app push notifications).
